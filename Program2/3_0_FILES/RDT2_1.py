...
class RDT:
    ...
    def rdt_2_1_send(self, msg_S, ACK='A'):
        ...
        self.network.udt_send(p.get_byte_S())
        #print self.role_S + " is sending an ack_type of: " + ACK
        #print "with sequence number of " + str(self.seq_num)
    ...
    def rdt_2_1_receive(self):
        ...
        while True:
            ...
            #print "received non corrupt packet: "
            #print "ack_type = " + p.ack
            ...
            if (p.ack == 'N'):
                #print self.role_S + " RECEIVED NAK!"
                self.role_play(self.role_S)
                self.byte_buffer = self.byte_buffer[length:]
                return ret_S
